/**
 * @fileoverview Core Design Tokens - ADDX-inspired design system for GreenLink Capital
 * @version 1.0.0
 */

import type { DesignTokens } from './types';

// Base color palette (ADDX-inspired)
...
export const colors = coreTokens.colors;
export const typography = coreTokens.typography;
export const spacing = coreTokens.spacing;
export const shadows = coreTokens.shadows;
export const animation = coreTokens.animation;
export const breakpoints = coreTokens.breakpoints;

// Export the complete token set as default
